...
def e() -> float:
    ...
    """
    return 2.7182818284590452353602874713526624977572470936999595749669676277240766
...
def phi() -> float:
    ...
    """
    return 1.6180339887498948482045868343656381177203091798057628621354486227052604
